...
const BINARY_EXTENSION_CHUNK_TYPES = { JSON: 0x4e4f534a, BIN: 0x004e4942, JSON_EXT: 0x4e4f534a + 66, BIN_EXT: 0x004e4942 + 66 }
...
class GLTFBinaryExtension {
  constructor(data) {
    ...
    while (chunkIndex < chunkContentsLength) {
      ...
      if (chunkType === BINARY_EXTENSION_CHUNK_TYPES.JSON || chunkType === BINARY_EXTENSION_CHUNK_TYPES.JSON_EXT) {
        const contentArray = new Uint8Array(data, BINARY_EXTENSION_HEADER_LENGTH + chunkIndex, chunkLength)
        this.content = textDecoder.decode(contentArray)
      } else if (chunkType === BINARY_EXTENSION_CHUNK_TYPES.BIN || chunkType === BINARY_EXTENSION_CHUNK_TYPES.BIN_EXT) {
